...
| UI-011 | P1 | BaseInput | BaseInput still owns labels/help/errors/floating-label/presentation | BaseInput is low-level CVA/control state only |
...
| UI-021 | P1 | Public API | SharedModule exports internal renderers/TableCell/TableFilter and retains legacy grouping | Public exports reduced to true public primitives/patterns/layout/overlay/feedback/data-display |
| UI-022 | P2 | Storybook | Preview forces light theme | Toolbar-controlled light/dark + required viewports |
