...
@Component({ selector: 'app-slider', standalone: false, template: '' })
...
describe('CandleChart template controls', () => {
  ...
  it('renders replay controls through shared controls', async () => {
    fixture.componentRef.setInput('mode', 'REPLAY');
    fixture.componentRef.setInput('candles', [
      { index: 0, time: '09:00', open: 1, high: 2, low: 0.5, close: 1.5 },
      { index: 1, time: '10:00', open: 1.5, high: 3, low: 1, close: 2.5 },
    ...
    expect(fixture.debugElement.query(By.css('app-select'))).toBeTruthy();
    expect(fixture.debugElement.query(By.css('app-slider'))).toBeTruthy();
    expect(fixture.debugElement.query(By.css('p-select'))).toBeNull();
    expect(fixture.debugElement.query(By.css('p-slider'))).toBeNull();
