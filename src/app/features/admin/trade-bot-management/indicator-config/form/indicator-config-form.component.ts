...
import { IndicatorConfigDto, IndicatorConfigResponse } from '../../../../../core/models/trade-bot/trading-system.model';
...
import { INDICATOR_FORM, TRADE_BOT_ROUTES } from '../../trade-bot-runtime.constants';
...
export class IndicatorConfigFormComponent implements OnInit {
  readonly formConfig = INDICATOR_FORM;
  ...
  private load(id: string): void {
    this.submitting.set(true);
    this.loadingService
      .track(this.service.getIndicatorConfig(id))
      .pipe(finalize(() => this.submitting.set(false)))
      .subscribe({
