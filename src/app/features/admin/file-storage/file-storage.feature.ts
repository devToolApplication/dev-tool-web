...
import { UploadStorageFormComponent } from './storage/form/upload-storage-form.component';
import { UploadStorageListComponent } from './storage/list/upload-storage-list.component';
