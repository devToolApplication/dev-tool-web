...
import { McpCategoryFormComponent } from './category/form/mcp-category-form.component';
import { McpCategoryListComponent } from './category/list/mcp-category-list.component';
import { McpToolFormComponent } from './tool/form/mcp-tool-form.component';
import { McpToolListComponent } from './tool/list/mcp-tool-list.component';
