...
export class AiAgentConfigListComponent extends BasePagedList<AiAgentConfigResponse> implements OnInit {
  readonly tableConfig: TableConfig = {
    title: 'systemManagement.aiAgentConfig.list.title',
    stateKey: 'system-management.ai-agent-configs',
    ...
    columns: [
      ...
      { field: 'configGroup', header: 'systemManagement.field.configGroup', sortable: true },
  ...
  protected loadPage(): void {
    this.runPageRequest(this.loadingService.track(this.service.getPage(this.page, this.pageSize, this.sorts, this.filters)), {
      errorMessage: 'systemManagement.aiAgentConfig.toast.loadListFailed',
      onError: () => this.toastService.error('systemManagement.aiAgentConfig.toast.loadListFailed')
    });
  }
}
