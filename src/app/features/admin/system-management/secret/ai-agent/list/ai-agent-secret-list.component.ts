...
export class AiAgentSecretListComponent implements OnInit {
  readonly tableConfig: TableConfig = {
    title: 'AI Agent Secrets',
  ...
  private loadPage(): void {
    ...
    this.loadingService
      ...
      .subscribe({
      next: (res: BasePageResponse<AiAgentSecretResponse>) => (this.rows = res.data ?? []),
      error: () => this.toastService.error('Load AI Agent secrets failed')
    });
  }
}
