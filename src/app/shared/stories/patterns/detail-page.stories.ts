...
const timelineItems: TimelineItem[] = [
  ...
  },
  {
    ...
    description: 'Timeout increased from 3000ms to 5000ms.',
    variant: 'info',
  ...
  },
  {
    ...
    variant: 'danger',
    time: '2026-05-24 03:15',
  },
  {
    title: 'Auto-recovered',
    description: 'Service restarted after 2 failed attempts.',
    variant: 'muted',
    time: '2026-05-24 03:18',
  },
  {
    title: 'Created',
    description: 'Initial deployment from CI/CD pipeline.',
    variant: 'success',
